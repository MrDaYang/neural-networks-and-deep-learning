...
net.SGD(training_data, epochs, mini_batch_size, eta, evaluation_data=test_data,lmbda=lamda, momentum=momenta, monitor_evaluation_cost=True, monitor_evaluation_accuracy=True, monitor_training_cost=True,  monitor_training_accuracy=True)
print "Complete!"